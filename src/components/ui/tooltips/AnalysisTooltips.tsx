...
export const analysisTypeTooltips = {
  ...
  "Gann": "نظرية غان تعتمد على العلاقة بين السعر والزمن والهندسة للتنبؤ باتجاهات السوق المستقبلية",
  "Waves": "تحليل موجات إليوت لتحديد اتجاهات السوق من خلال دراسة الأنماط الموجية المتكررة",
  "Patterns": "تحليل الأنماط الفنية على الشارت مثل الرأس والكتفين، المثلثات، والقنوات السعرية",
  "Price Action": "تحليل حركة السعر بدون مؤشرات اعتماداً على شموع الأسعار وهيكلية السوق"
};
