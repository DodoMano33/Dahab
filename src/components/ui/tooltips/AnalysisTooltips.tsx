...
export const analysisTypeTooltips = {
  ...
  "Smart": "Analysis using artificial intelligence to combine various analytical methods",
  "SMC": "Smart Money Concept analysis focusing on institutional money movements",
  "ICT": "Inner Circle Trader - analytical method focusing on market maker behavior",
  "Turtle Soup": "Trading strategy targeting false breakouts",
  "Gann": "Gann theory based on the relationship between price and time",
  "Waves": "Elliott Wave analysis for determining market trends",
  ...
  "Fibonacci Advanced": "Advanced analysis using Fibonacci levels with other tools to infer precise reversal and correction points",
  "Neural Networks": "Using artificial neural networks to analyze data and predict price movements",
  "RNN": "Advanced neural networks used to predict time series and recurring patterns",
  ...
  "Composite Candlestick": "Analysis strategy that combines multiple candlestick patterns to infer more accurate entry and exit signals",
...
export const timeframeTooltips = {
  ...
  "1h": "Medium timeframe (1 hour) suitable for day and swing trading",
  "4h": "Medium-long timeframe (4 hours) for swing trading",
