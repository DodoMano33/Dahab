...
import { AnalysisStatsChartProps } from './types';

export const AnalysisStatsChart = ({ data, isLoading }: AnalysisStatsChartProps) => {
  if (isLoading) {
    return (
  ...
  // Filter out analysis types with no data
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip 
                ...
                labelFormatter={(label) => `نوع التحليل: ${label}`}
              />
              <Legend 
                payload={[
