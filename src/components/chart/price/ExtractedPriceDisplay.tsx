...
export const ExtractedPriceDisplay: React.FC = () => {
  ...
  const { capturedImage, captureAttempts, captureTradingViewWidget } = useImageCapture();
  const { recognizedText, extractedPrice, isProcessingOCR, processImageWithOCR } = useOcrProcessor();
