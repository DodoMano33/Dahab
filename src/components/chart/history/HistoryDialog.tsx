  ...
  return <Dialog open={isOpen} onOpenChange={open => !open && onClose()}>
      <DialogContent className="max-w-[95vw] w-[1200px] p-6 h-[90vh] flex flex-col" dir="rtl">
        <div className="flex items-center justify-between">
          ...
          {refreshHistory && <div className="flex gap-2">
              
              <Button variant="outline" size="sm" onClick={refreshHistory} disabled={isRefreshing} className="mr-2">
        ...
        <div className="flex justify-end p-2">
          <HistoryActions selectedItems={selectedItems} onDelete={handleDeleteSelected} history={validHistory} />
        </div>
        <div className="flex-1 overflow-hidden mt-4">
          <HistoryContent history={validHistory} onDelete={onDelete} selectedItems={selectedItems} onSelect={handleSelect} />
        </div>
      </DialogContent>
    </Dialog>;
};