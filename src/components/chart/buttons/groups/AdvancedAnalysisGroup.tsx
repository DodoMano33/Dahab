...
export const AdvancedAnalysisGroup = ({
  ...
  return (
    <div className="space-y-2">
      {/* First row - Neural Networks and RNN */}
      ...
      {/* Second row - Time Clustering, Multi Variance, Composite Candlestick */}
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                className="bg-gradient-to-r from-violet-500 to-violet-600 hover:from-violet-600 hover:to-violet-700 shadow-md text-white h-12 sm:h-10 w-full flex items-center justify-center gap-2 rounded-lg transition-all duration-300 ease-in-out transform hover:scale-[1.02] active:scale-[0.98]"
              >
