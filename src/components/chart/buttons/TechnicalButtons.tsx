  ...
  return (
    <>
      <Button
        ...
        onClick={onSMCClick}
        className="bg-orange-600 hover:bg-orange-700 text-white flex items-center gap-2 text-sm py-1.5"
      >
      ...
      <Button
        ...
        className="bg-green-600 hover:bg-green-700 text-white flex items-center gap-2 text-sm py-1.5"
      >
      ...
      <Button
        ...
        disabled={isAnalyzing}
        onClick={onGannClick}
        className="bg-yellow-600 hover:bg-yellow-700 text-white flex items-center gap-2 text-sm py-1.5"
      >
